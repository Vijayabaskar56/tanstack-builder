...
function BuilderComponent() {
	...
	return (
		<main className="lg:h-[calc(100vh-8rem)] h-[calc(100vh-12rem)] flex flex-col md:flex-row overflow-hidden bg-gradient-to-br from-background via-background to-muted/20 w-full">
			{/* Dynamic Sidebar - Top on mobile, Left on desktop */}
			{!isMobile && (
			...
			<div className="flex w-full bg-gradient-to-br from-background via-background to-muted/10 min-h-0">
				<ScrollArea className="h-full w-full">
					<div className="pt-4 pb-20 flex flex-col lg:flex-row">
						{/* Dynamic Sidebar for Mobile - Integrated into Form Preview and Edition */}
						{isMobile && (
							<div className="w-full mb-4">{renderSidebarContent()}</div>
						)}
						{/* Form Edit Section */}
						<div className="flex-1 w-full lg:flex-1 py-6 px-4 border-b lg:border-b-0 lg:border-r border-dashed">
							<FormEdit />
						</div>

						{/* Form Preview Section */}
						<div className="flex-1 w-full lg:w-80 xl:w-96 px-2 pb-6">
