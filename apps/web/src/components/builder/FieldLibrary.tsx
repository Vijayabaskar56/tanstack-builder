...
export function FieldTab({ onAddField }: FieldLibraryProps) {
  ...
  return (
    <div className="flex flex-col h-full">
     <div className="flex-shrink-0 p-4 border-b">
      <h2 className="text-lg font-semibold mb-4">Field Library</h2>
          ...
          <div className="space-y-2">
           {group.fields.map((field) => {
            ...
            return (
             <Card
              key={field.type}
              className="cursor-pointer py-2 hover:shadow-md transition-shadow border-dashed hover:border-solid"
...
export function FieldLibrary({ onAddField }: FieldLibraryProps) {
  return <FieldTab onAddField={onAddField} />;
}
